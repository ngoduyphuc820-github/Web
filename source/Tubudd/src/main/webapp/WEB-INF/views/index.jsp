...
<body class="animsition">
		...
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1"
					style="background-image: url(${pageContext.request.contextPath}/images/slides-01.jpg);">
					<div
						...
						<h2
							...
							data-appear="fadeInUp">Gonatour</h2>
				...
				<div class="item-slick1 item2-slick1"
					style="background-image: url(${pageContext.request.contextPath}/images/slides-02.jpg);">
					<div
						class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						<span
							class="caption1-slide1 txt1 t-center animated visible-false m-b-15"
						...
						<h2
							class="caption2-slide1 tit1 t-center animated visible-false m-b-37"
							data-appear="lightSpeedIn">Gonatour</h2>
				...
				<div class="item-slick1 item3-slick1"
					style="background-image: url(${pageContext.request.contextPath}/images/slides-03.jpg);">
					<div
						class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						<span
							class="caption1-slide1 txt1 t-center animated visible-false m-b-15"
						...
						<h2
							class="caption2-slide1 tit1 t-center animated visible-false m-b-37"
							data-appear="rotateInUpRight">Gonatour</h2>
			...
			<div class="row">
				<div class="col-md-6 p-t-45 p-b-30">
					<div class="wrap-text-welcome t-center">
						<span class="tit2 t-center"> Gonatour </span>

						<h3 class="tit3 t-center m-b-35 m-t-5">Welcome</h3>

						<p class="t-center m-b-22 size3 m-l-r-auto">Gonatour is
							operated by professional, elite and skilled travel experts who
							have experienced many experiences and challenges at leading
							tourism corporations and held key positions in top travel
							companies 10 Vietnam..</p>

						<a href="about" class="txt4"> More <i
							class="fa fa-long-arrow-right m-l-10" aria-hidden="true"></i>
						</a>
					</div>
				</div>
				...
				<div class="col-md-6 p-b-30">
					<div
						...
						<img src="${pageContext.request.contextPath}/images/our-story-01.jpg" alt="IMG-OUR">
					</div>
				</div>
			</div>
		</div>
	...
	<section class="section-intro">
		<div class="header-intro parallax100 t-center p-t-135 p-b-158"
			style="background-image: url(${pageContext.request.contextPath}/images/bg-intro-01.jpg);">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="#"><img src="${pageContext.request.contextPath}/images/intro-01.jpg" width="296"
									height="292" alt="IMG-INTRO"></a>
							</div>

							<div class="wrap-text-blo1 p-t-35">
								<a href="#"><h4 class="txt5 color0-hov trans-0-4 m-b-13">
										Discover Southern</h4></a>

								<p class="m-b-20">Phasellus lorem enim, luctus ut velit
									eget, con-vallis egestas eros.</p>

								<a href="#" class="txt4"> Learn More <i
									class="fa fa-long-arrow-right m-l-10" aria-hidden="true"></i>
								</a>
							</div>
						</div>
					...
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="#"><img src="${pageContext.request.contextPath}/images/intro-02.jpg" width="296"
									height="292" alt="IMG-INTRO"></a>
							</div>

							<div class="wrap-text-blo1 p-t-35">
								<a href="#"><h4 class="txt5 color0-hov trans-0-4 m-b-13">
										Discover Northern</h4></a>

								<p class="m-b-20">Aliquam eget aliquam magna, quis posuere
									risus ac justo ipsum nibh urna</p>
					...
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="#"><img src="${pageContext.request.contextPath}/images/intro-03.jpg" width="296"
									height="292" alt="IMG-INTRO"></a>
							</div>

							<div class="wrap-text-blo1 p-t-35">
								<a href="#"><h4 class="txt5 color0-hov trans-0-4 m-b-13">
										Discover central</h4></a>

								<p class="m-b-20">Sed ornare ligula eget tortor tempor, quis
									porta tellus dictum.</p>
			...
			<div class="row">
				<div class="col-lg-6 p-b-30">
					<div class="t-center">
						...
						<h3 class="tit3 t-center m-b-35 m-t-2">Book tour</h3>
					</div>
					...
					<form class="wrap-form-booking">
						...
						<div class="wrap-btn-booking flex-c-m m-t-6">
							<!-- Button3 -->
							<button type="submit"
								class="btn3 flex-c-m size13 txt11 trans-0-4">Book Tour
							</button>
						</div>
					</form>
				</div>
				...
				<div class="col-lg-6 p-b-30 p-t-18">
					<div
						...
						<img src="${pageContext.request.contextPath}/images/booking-01.jpg" alt="IMG-OUR" width="500" height="400">
					</div>
				</div>
			</div>
		</div>
